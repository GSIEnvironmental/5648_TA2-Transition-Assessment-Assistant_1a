...
* If you enter data from multiple Pre-Remediation events for a well, the tool will plot the average concentration for the Pre-Remediation events from that well.
* If you enter data from multiple Post-Remediation events for a well, the tool will plot the average concentration for the Post-Remediation events from that well.
* If you don’t want to plot the average concentration, then only enter the data from the event you want to evaluate.
